...
class D0_constructor : Dfunction
{
    ...
    override Value* Construct(CallContext *cc, Value *ret, Value[] arglist)
    {
        ...
        m = (arglist.length) ? &arglist[0] : &Value.vundefined;
...
template proto(alias TEXT_D1)
{
    ...
    class D0 : Dobject
    {
        ...
        this(ErrInfo errinfo) {
            ...
            this.errinfo = errinfo;
            Put(TEXT_number, (errinfo.cc && errinfo.cc.code)?(cast(d_number)errinfo.cc.code.opcode):0, 0);
        }

        override void getErrInfo(out ErrInfo errinfo) {
